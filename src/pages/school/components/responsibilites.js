    ...
    <div className="flex flex-col md:flex-row justify-center gap-4 md:gap-16 mx-10 md:mx-20 text-cWhite">
      <div className="w-full md:w-1/2 bg-cRed p-4 rounded-lg shadow-md mx-auto flex flex-col justify-between">
        <div>
          ...
          <ul className="mt-4">
            <li className="mb-2"><b>{commitment}:</b> {fullTimeAttendance}</li>
            <li className="mb-2"><b>{groupDynamics}:</b> {placedInGroups}</li>
            <li className="mb-2"><b>{engagement}:</b> {participateDiscussions}</li>
      ...
      <div className="w-full md:w-1/2 bg-cGreen p-4 rounded-lg shadow-md mx-auto flex flex-col justify-between text-cWhite">
        <div>
          ...
          <ul className="mt-4">
            <li className="mb-2"><b>{role}:</b> {leadGuideResearch}</li>
            <li className="mb-2"><b>{responsibilities}:</b> {facilitateLearning}</li>
            <li className="mb-2"><b>{position}:</b> {fullTimeTemporary}</li>
